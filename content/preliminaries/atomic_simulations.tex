...
\begin{figure}
    \includegraphics[width=180mm]{atomic_simulations/dimenetMS.png}
    \caption{Aggregation
    scheme for message
...
\begin{figure}
    \includegraphics[width=180mm]{atomic_simulations/DimenetArch.png}
...
\begin{figure}
\includegraphics[width=180mm]{atomic_simulations/dimenet++.png}
