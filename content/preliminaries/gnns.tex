...
We express GNNs via the Graph Network/Extended Graph Network (GN/EGN) framework introduced in 
...
individual building blocks. EGNs \cite{https://doi.org/10.48550/arxiv.2203.09697}, which we will 
...
Most of this section is an outline of \cite[Section 3.2]{https://doi.org/10.48550/arxiv.1806.01261}. Within the GN framework, a graph is modeled as a 3-tuple
\[ G \: = \: (\uu, V, E) \text{,} \]
...
The Extended Graph Network (EGN) framework \cite[Section 2.1]{https://doi.org/10.48550/arxiv.2203.09697} is a generalization of GNs to graphs which 
